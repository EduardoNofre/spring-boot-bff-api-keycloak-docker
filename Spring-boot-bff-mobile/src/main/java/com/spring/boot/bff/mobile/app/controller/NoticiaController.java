...
import com.spring.boot.bff.mobile.app.service.NoticiaService;
...
@RestController
@RequestMapping("/bff-noticia")
@Tag(name = "NoticiaController", description = "Recurso bff noticia controller BFF")
