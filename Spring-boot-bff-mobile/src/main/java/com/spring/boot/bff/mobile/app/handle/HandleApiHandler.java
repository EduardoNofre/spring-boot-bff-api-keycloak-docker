package com.spring.boot.bff.mobile.app.handle;
...
@ControllerAdvice
@Hidden
public class HandleApiHandler extends ResponseEntityExceptionHandler implements Serializable {

	private static final long serialVersionUID = 4790038517549729374L;

	public HandleApiHandler() {
		super();
	}
	...
	public ResponseEntity<ErrorResponse> handle(HandleException e) {
	...
	/*
	 * Usado pelo FeignException para capturar exceções do Client OpenFeign lança
	 * execeçoes do tipo FeignException
	 * 
	 */
	...
	public ResponseEntity<String> connectException(FeignException ex) {
