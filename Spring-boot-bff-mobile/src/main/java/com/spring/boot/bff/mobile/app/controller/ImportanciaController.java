package com.spring.boot.bff.mobile.app.controller;
...
import com.spring.boot.bff.mobile.app.service.ImportanciaService;
...
@RestController
@RequestMapping("/bff-importancia")
@Tag(name = "ImportanciaController", description = "Recurso bff importancia controller BFF")
