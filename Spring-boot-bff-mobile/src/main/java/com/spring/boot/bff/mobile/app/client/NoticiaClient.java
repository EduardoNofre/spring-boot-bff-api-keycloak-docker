...
//	public ResponseEntity<List<NoticiaDTO>> listarNoticiaCategoria(NoticiaDTO noticiaDTO);
//	
//	public ResponseEntity<NoticiaDTO> inserirNoticiaCategoria(NoticiaDTO noticiaDTO);
}
